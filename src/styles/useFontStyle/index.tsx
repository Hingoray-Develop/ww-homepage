...
export interface UseFontStyleProps extends UseFontStyle, Partial<Record<ResponsiveType, UseFontStyle>> {}
...
export default function useFontStyle(props: UseFontStyleProps) {
  ...
  const getFontStyle: CSSProperties = useMemo(() => {
    ...
    return {
      ...
      textUnderlineOffset: getFont("underlineOffset") as keyof UseFontStyle["underlineOffset"],
    };
