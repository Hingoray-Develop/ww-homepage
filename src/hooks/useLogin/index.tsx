...
export type SOCIAL_LOGIN_PROVIDER_TYPE = (typeof SOCIAL_LOGIN_PROVIDER)[keyof typeof SOCIAL_LOGIN_PROVIDER];
...
export default function useLogin() {
  ...
  const handleSocialLogin = async (provider: SOCIAL_LOGIN_PROVIDER_TYPE, appleCallback: () => void = () => {}) => {
    if (fromApp) {
      ...
      const REDIRECT_URI = `${import.meta.env.VITE_REDIRECT_URI}/${provider.toLowerCase()}`;
